...
@WebServlet(name = "horariosservlet", value = "/horarios-servlet")
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection connection = MySQLConnection.getConnections()) {
            ...
            System.out.println("Valor seleccionado: " + aulaId);
                ...
                PreparedStatement sentencia3 = connection.prepareStatement("SELECT * FROM horarios WHERE id_aula = ?");
                ...
                for (Horarios horario : horarios) {
                    ...
                    LocalDateTime fechaModificadaEnd = fechaOriginalEnd.minusMonths(1).minusMinutes(5); // subtract 10 minutes
