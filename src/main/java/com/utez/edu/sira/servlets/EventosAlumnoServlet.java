...
@WebServlet(name = "eventosalumnoservlet", value = "/eventos-alumno-servlet")
public class EventosAlumnoServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection connection = MySQLConnection.getConnections()) {
            ...
            System.out.println("Valor seleccionado: " + aulaId);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("horarios-servlet?opcion=3");
