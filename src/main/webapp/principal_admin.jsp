...
<head>
    ...
    <link rel="stylesheet" href="styles/style_calendar-admin.css">
...
<div class="barra">
    ...
    <div class="aula_seleccionada">
        <h1 class="aula_select"></h1>
    </div>
...
<nav id="nav-list">
    <ul class="list">
        ...
        <li><a href="buildings-and-rooms-servlet?opcion=2" id="">
