...
<div class="barra">
    ...
    <div class="close">
        <a href="buildings-servlet?opcion=7">Volver</a>
    </div>
...
<div class="formulario-registro form_4 form_2">
    ...
    <form method="post" action="remove-reserva-form-servlet"  >
    ...
    <form method="post" action="edit-reservas-servlet"  >
        ...
        <script>
            document.getElementsByName("building-select")[0].onchange = function () {
                ...
                window.location.href = "buildings-servlet?opcion=12&buildingId=" +selectValue;
